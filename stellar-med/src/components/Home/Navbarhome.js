...
const navigation = [
  ...
  { name: 'Diagnose', href: '#', current: false },
...
export default function Navbarhome() {
  ...
  function handleMonitoring(event){
    navigate('./Monitoring');
        ...
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 ">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full mx-3" onClick={handleClick}>
               Login
             </button>
             <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full mx-3" onClick={handleMonitoring}>
              Monitoring           
             </button>
                {/* <button
                  type="button"
