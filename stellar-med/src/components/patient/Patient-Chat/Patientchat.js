...
export default function Patientchat(props) {
  ...
  return (
    <div className=" h-auto w-64 rounded-2xl bg-white opacity-90 p-1">
      <h1 className="bg-sky-300 rounded-xl p-1">Chat Messages</h1>
      ...
      <Patientinput data={messageFlagRef.current} updateMessages={updateMessages} />
    </div>
  );
}
